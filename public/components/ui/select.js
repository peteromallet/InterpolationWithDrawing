...
import * as SelectPrimitive from 'https://cdn.skypack.dev/@radix-ui/react-select@1.2.2';
import { Check, ChevronDown } from 'https://cdn.skypack.dev/lucide-react@0.468.0';
...
const SelectContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Content
    ref={ref}
    className={cn(
      "overflow-hidden rounded-md bg-background p-1 text-popover-foreground shadow-lg",
      className
    )}
    {...props}
  >
